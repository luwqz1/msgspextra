...
type Converter = typing.Callable[[typing.Any], typing.Any]
...
@typing.overload
def field(*, default_factory: Factory, name: str | None = None) -> typing.Any: ...
@typing.overload
def field(*, default_factory: Factory, alias: str) -> typing.Any: ...
@typing.overload
def field(*, converter: Converter, name: str | None = ...) -> typing.Any: ...
@typing.overload
def field(*, converter: Converter, alias: str) -> typing.Any: ...
@typing.overload
def field(*, default: typing.Any, converter: Converter, name: str | None = ...) -> typing.Any: ...
@typing.overload
def field(*, default: typing.Any, converter: Converter, alias: str) -> typing.Any: ...
@typing.overload
def field(
    *,
...
class DefaultFactory:
    def __init__(self, *, on_init: Factory, on_decode: Factory = ..., default: typing.Any = ...) -> None: ...
...
__all__ = ("UNSET", "DefaultFactory", "Deprecated", "From", "InitVar", "Model", "ModelMeta", "field")
